 ...
 */
/*
 * To compile you require: CharArray.java, IntUtil.java RandomInt.java Cstring.java  BigUnsignedNumber.java BigUnsignedNumberTester.java BigUnsignedNumber.java  
 */
import java.util.Random;
//NOTHING CAN BE CHANGED IN THIS FILE.
//If you have problem with name clone(), you can change clone() to klone()
...
class BigUnsignedNumberTester {
  ...
  private static void testMult() {
    ...
    {
    	BigUnsignedNumber x = new BigUnsignedNumber("5432");
        BigUnsignedNumber y = new BigUnsignedNumber("345");
        BigUnsignedNumber z = new BigUnsignedNumber("1874040");
        BigUnsignedNumber t = y.mult(x) ;
        x.pLn("x = ") ;
        y.pLn("y = ") ;
        z.pLn("z = ") ;
        t.pLn("t = ") ;
        u.myassert(t.isEqual(z)) ;	
    }*/
    {
  ...
  private static void testFact() {
	  // BigUnsignedNumber fact5 = new BigUnsignedNumber(120);
	  // int res = fact5.fact(5);
	  // fact5.pLn("a = ") ;
	  // System.out.println(res);

	   // BigUnsignedNumber fact5 = new BigUnsignedNumber(120);
	   //int res = fact5.recursiveFactorial(5);
	   // fact5.pLn("a = ") ;
	   // System.out.println(res);
  ...
  public static void main(String[] args) {
    ...
    testBench();
    System.out.println("BigUnsignedNumberTester.java Done");
  }
